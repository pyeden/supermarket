...
class Goods(BaseModel):
    ...
    category = models.ForeignKey(GoodsCategory, verbose_name='商品分类', on_delete=models.CASCADE, to_field="id", related_name='category_goods')
    ...
    kanjia = models.BooleanField('是否参加砍价', null=True, blank=True, choices=BOOL_CHOICE, default=False)
    kanjiaPrice = models.FloatField('砍价价格', null=True, blank=True, default=0)
    ...
    maxCoupons = models.IntegerField('最大优惠', null=True, blank=True, default=0)
    miaosha = models.BooleanField('是否参加秒杀', null=True, blank=True, choices=BOOL_CHOICE, default=False)
    minBuyNumber = models.IntegerField('最少购买数量', null=True, blank=True, default=0)
    minPrice = models.FloatField('最低价', null=True, blank=True, default=0)
    minScore = models.IntegerField('最低积分', null=True, blank=True, default=0)
    ...
    numberGoodReputation = models.IntegerField('商品评价人数', null=True, blank=True, default=0)
    numberOrders = models.IntegerField('订单数量', null=True, blank=True, default=0)
    ...
    pingtuan = models.BooleanField('是否拼团', null=True, blank=True, choices=BOOL_CHOICE, default=False)
    pingtuanPrice = models.FloatField('拼团价格', null=True, blank=True, default=0)
    recommendStatus = models.IntegerField('是否推荐商品', null=True, blank=True, choices=RECOMMEND, default=0)
    recommendStatusStr = models.CharField('推荐状态', max_length=255, null=True, blank=True, default='0')
    seckillBuyNumber = models.IntegerField('商品秒杀数量', null=True, blank=True, default=0)
    sellEnd = models.BooleanField('是否停售', null=True, blank=True, choices=BOOL_CHOICE, default=False)
    sellStart = models.BooleanField('是否开始销售', null=True, blank=True, choices=BOOL_CHOICE, default=True)
    shopId = models.IntegerField('商店ID', null=True, blank=True, default=0)
...
class ShopCart(BaseModel):
    ...
    key = models.CharField('购物车编号', max_length=255, null=True, blank=True, default='5b2a16e8d15d25b416e87f228b6d50f3')
